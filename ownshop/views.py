...
def admin_view(request):
    resp = render(request,"ownshop/adminpages/adminpage.html")
    return resp
...
def admin_orders_view(request):
    ...
    d = {"orders":orders}
    resp = render(request,"ownshop/adminpages/adminorders.html",context=d)
    return resp

def admin_contact_view(request):
    contacts = Contact.objects.all()
    d = {"contacts":contacts}
    resp = render(request,"ownshop/adminpages/admincontacts.html",context=d)
    return resp
...
def admin_products_view(request):
    ...
    d = {"products":products}
    resp = render(request,"ownshop/adminpages/adminproducts.html",context=d)
    return resp

def admin_users_view(request):
    users = User.objects.all()
    d = {"users":users}
    resp = render(request,"ownshop/adminpages/adminusers.html",context=d)
    return resp
...
def add_product_details(request):
    if request.method == "POST":
        ...
        resp = render(request,"ownshop/adminpages/adminproducts.html",context=d)
        return resp
    resp = render(request,"ownshop/adminpages/addproductdetails.html")
    return resp
...
def edit_product_details(request,myid):
    ...
    if request.method == "POST":
        if "delProduct" in request.POST:
            ...
            resp = render(request,"ownshop/adminpages/adminproducts.html",context=d1)
            return resp
            ...
            cur_product.image = request.FILES['image']
            cur_product.save()
            resp = render(request,"ownshop/adminpages/editproductdetails.html",context=d)
            return resp
    resp = render(request,"ownshop/adminpages/editproductdetails.html",context=d)
    return resp
...
def add_user_details(request):
    if request.method == "POST":
        ...
        resp = render(request,"ownshop/adminpages/adminusers.html",context=d)
        return resp
    resp = render(request,"ownshop/adminpages/adduserdetails.html")
    return resp
...
def edit_user_details(request,myid):
    ...
    if request.method == "POST":
        if "delUser" in request.POST:
            ...
            resp = render(request,"ownshop/adminpages/adminusers.html",context=d1)
            return resp
            ...
            cur_user.password = make_password(request.POST.get("password"))
            cur_user.save()
            resp = render(request,"ownshop/adminpages/edituserdetails.html",context=d)
            return resp
    resp = render(request,"ownshop/adminpages/edituserdetails.html",context=d)
    return resp
...
def add_contact_details(request):
    if request.method == "POST":
        ...
        resp = render(request,"ownshop/adminpages/admincontacts.html",context=d)
        return resp
    resp = render(request,"ownshop/adminpages/addcontactdetails.html")
    return resp
...
def edit_contact_details(request,myid):
    ...
    if request.method == "POST":
        if "delContact" in request.POST:
            ...
            resp = render(request,"ownshop/adminpages/admincontacts.html",context=d1)
            return resp
            ...
            cur_contact.desc = request.POST.get("desc")
            cur_contact.save()
            resp = render(request,"ownshop/adminpages/editcontactdetails.html",context=d)
            return resp
    resp = render(request,"ownshop/adminpages/editcontactdetails.html",context=d)
    return resp
...
def add_order_details(request):
    if request.method == "POST":
        ...
        resp = render(request,"ownshop/adminpages/adminorders.html",context=d)
        return resp
    resp = render(request,"ownshop/adminpages/addorderdetails.html")
    return resp
...
def edit_order_details(request,myid):
    ...
    if request.method == "POST":
        if "delOrder" in request.POST:
            ...
            resp = render(request,"ownshop/adminpages/adminorders.html",context=d1)
            return resp
            ...
            cur_order.mobile = request.POST.get("mobile")
            cur_order.save()
            resp = render(request,"ownshop/adminpages/editorderdetails.html",context=d)
            return resp
    resp = render(request,"ownshop/adminpages/editorderdetails.html",context=d)
    return resp
